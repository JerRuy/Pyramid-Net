...
if __name__ == '__main__':
    parser = ArgumentParser(description="Evaluation script for Pyramid-Net models",formatter_class=ArgumentDefaultsHelpFormatter)
    ...
    net = PUNet().cuda()
    net.eval()
    net = loadweight(net, args.model_path+'Pyramid-Net_DRIVE.th')
